var config = {
    ...
    footer: 'Fuentes: Propiedades.com, Inmuebles24, Metroscubicos. Creado por Paco Solsona usando <a href="https://github.com/mapbox/storytelling" target="_blank">Mapbox Storytelling</a> para <a href="https://geo-data-urbana.com/" target="_blank">Geodata Urbana</a>.',
    chapters: [
        {
            id: 'first-window',
            alignment: 'left',
